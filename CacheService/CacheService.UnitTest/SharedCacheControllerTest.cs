...
namespace CacheService.UnitTest
{
    public class SharedCacheControllerTest
    {
        [Fact]
        public async Task<string> SharedCacheController_Get_Should_Return_Non_Empty_String()
        {
            // ARRANGE
        ...
        [Fact]
        public async Task<string> SharedCacheController_Get_Should_Return_Empty_String_if_Cache_Does_Not_Contains_Store()
        {
            // ARRANGE
            var sharedCacheService = new Mock<ISharedCacheService>();
            var logger = new Mock<ILogger<ISharedCacheService>>();
        ...
        [Fact]
        public async Task<string> SharedCacheController_Get_Should_Return_Empty_String_if_Cache_Does_Not_Contains_Key()
        {
            // ARRANGE
            var sharedCacheService = new Mock<ISharedCacheService>();
            var logger = new Mock<ILogger<ISharedCacheService>>();
        ...
        [Fact]
        public async Task<IEnumerable<string>> SharedCacheController_GetAll_Should_Return_Empty_List_if_Cache_Does_Not_Contains_Store()
        {
            // ARRANGE
            var sharedCacheService = new Mock<ISharedCacheService>();
            var logger = new Mock<ILogger<ISharedCacheService>>();
        ...
        [Fact]
        public async Task<IEnumerable<string>> SharedCacheController_GetAll_Should_Return_Values_if_Cache_Does_Contains_Store()
        {
            // ARRANGE
            var sharedCacheService = new Mock<ISharedCacheService>();
            var logger = new Mock<ILogger<ISharedCacheService>>();
        ...
        [Fact]
        public async Task<IEnumerable<string>> SharedCacheController_GetStoreNames_Should_Return_Empty_Values_if_Cache_Is_Empty()
        {
            // ARRANGE
            var sharedCacheService = new Mock<ISharedCacheService>();
            var logger = new Mock<ILogger<ISharedCacheService>>();
        ...
        [Fact]
        public async Task<IEnumerable<string>> SharedCacheController_GetStoreNames_Should_Return_Stores_Name_if_Cache_Is_Not_Empty()
        {
            // ARRANGE
            var sharedCacheService = new Mock<ISharedCacheService>();
            var logger = new Mock<ILogger<ISharedCacheService>>();
        ...
        [Fact]
        public async Task<IEnumerable<string>> SharedCacheController_GetByKeys_Should_Return_Values_if_Cache_Is_Not_Empty()
        {
            // ARRANGE
            var sharedCacheService = new Mock<ISharedCacheService>();
            var logger = new Mock<ILogger<ISharedCacheService>>();
